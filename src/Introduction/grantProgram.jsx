...
const KnowTerence = () => (
	<Content id='grantProgram'>
		...
		透過於奧美廣告的貼身實習經驗，我們希望年輕學子對廣告行業有更透徹的認識與了解，並給予正確的行業觀念。
		<ul>
			<li>
				經本獎助計劃審核通過者，將由獎助委員安排至台北奧美廣告實習。實習期為暑假兩個月。確切日期依每年時間表作適當調整。
			</li>
			<li>
				經本獎助計劃審核通過者，將由獎助委員安排至台北奧美廣告實習。實習期為暑假兩個月。確切日期依每年時間表作適當調整。
			</li>
			<li>實習部門及實習工作內容將由本獎助計劃委員長指定。獎助者於實習期間，將可與正式員工接受相同訓練課程。</li>
			<li>獎助者於實習期間，將由獎助計劃委員長指派奧美廣告員工作為學長，給予實習期間的監督與協助。</li>
			<li>實習結束，經本計畫委員內部審核評估後，審核通過者於結業時發給兩萬元整獎助金。</li>
		</ul>
		<PhaseHeadline index='2' text='分享與回饋' />
		<ul>
			<li>受獎助者經階段一結束後，必須對本獎助委員會進行成果分享。分享形式及內容將由獎助委員會與獎助者進一步討論。</li>
