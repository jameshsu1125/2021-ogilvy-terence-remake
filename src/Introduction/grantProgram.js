...
const KnowTerence = () => (
	<Content id='grantProgram'>
		...
		<ul>
			<li>
				經本獎助計劃審核通過者，將由獎助委員安排至台灣奧美培訓。培訓期為暑假兩個月。確切日期依每年時間表作適當調整。
			</li>
			<li>培訓部門及內容將由本獎助計劃委員長指定。</li>
			<li>獎助者於培訓期間，將可與正式員工接受相同訓練課程。</li>
			<li>
				獎助者於培訓期間，將由獎助計劃委員長指派台灣奧美員工作為學長，給予培訓期間的監督與協助。
			</li>
			<li>培訓結束，經本計畫委員內部審核評估後，審核通過者於結業時發給兩萬元整獎助金。</li>
		</ul>
